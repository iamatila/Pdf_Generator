<script setup lang="ts">
  const items = shallowRef([
    ...
    //   href: 'https://tobiatilola.netlify.app/',
    // },
    {
      title: 'iamatila X',
      ...
      href: 'https://x.com/iamatila',
    },
    {
      title: 'iamatila GitHub',
      icon: `mdi-github`,
      href: 'https://github.com/iamatila',
    },
    // {
...
<template>
  ...
  >
    ...
    >
      &copy; 2016-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">@iamatila on all socials</span>
      —
      <NuxtLink
